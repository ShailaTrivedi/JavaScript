        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-5">
              <h2 class="ftco-heading-2 logo">ACHARYA<span>CARE</span></h2>
            ...
            <div class="ftco-footer-widget mb-5">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">ASHUTOSH, JIVANDEEP COLONY, ANAND</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+1-(647)-518-4154</</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">acharyamedical@gmail.com</span></a></li>
	              </ul>
	            </div>
