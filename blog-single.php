...
<html lang="en">
  <head>
    <title>ACHARYA CARE - WE CARE YOUR HEALTH</title>
    <meta charset="utf-8">
		...
		<section class="ftco-section">
          ...
          <div class="col-lg-8 ftco-animate">
            ...
            <div class="pt-5 mt-5">
              ...
              <div class="comment-form-wrap pt-5">
                ...
                <form action="blog_comment_data.php" class="p-5 bg-light">
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
            	<h3>Category</h3>
              <ul class="categories">
                <li><a href="neurology.php">Neurology <span>(6)</span></a></li>
                <li><a href="cardiology.php">Cardiology <span>(8)</span></a></li>
                <li><a href="surgical.php">Surgery <span>(2)</span></a></li>
                <li><a href="dental.php">Dental <span>(2)</span></a></li>
                <li><a href="ophthalmology">Ophthalmology <span>(2)</span></a></li>
              </ul>
            </div>
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  <h3 class="heading"><a href="articles.php">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div class="meta">
                    <div><a href="http://www.calendar.com"><span class="icon-calendar"></span> Oct. 04, 2018</a></div>
                    <div><a href="http://www.calendar.com"><span class="icon-person"></span> Dave Lewis</a></div>
                    <div><a href="http://www.calendar.com"><span class="icon-chat"></span> 19</a></div>
                  </div>
                </div>
              </div>
              <div class="block-21 mb-4 d-flex">
